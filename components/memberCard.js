export default function SingleCard({id, name, position, bio, image, fbHref, webHref}){
    return(
        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="p-5">
                            ...
                            <ul className="flex space-x-4 sm:mt-0">
                                <li>
                                    <a href={fbHref ? fbHref : "/#"} className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                                ...
                                <li>
                                    <a href={webHref ? webHref : "/#"} className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
